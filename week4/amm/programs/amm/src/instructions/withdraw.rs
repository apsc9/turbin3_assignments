...
impl<'info>Withdraw<'info> {
    pub fn withdraw(
        &mut self,
        amount: u64,  // amnt of LP tokens user wants to burn
        min_x: u64,   // min amnt of token x that user wants to receive
        min_y: u64,   // min amnt of token y that user wants to receive
    ) -> Result<()> {
